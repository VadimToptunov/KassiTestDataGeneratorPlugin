...
object IbanRegistry {
    private val specs: Map<Country, IbanSpec> = buildMap {
        ...
        // Worldwide IBAN registry (ISO 13616) beyond Europe — lengths and BBAN layouts per the registry.
        put(Country.AE, 23, "3n,16n")
        put(Country.AZ, 28, "4a,20c")
        put(Country.BH, 22, "4a,14c")
        put(Country.BI, 27, "5n,5n,11n,2n")
        put(Country.BR, 29, "23n,1a,1c")
        put(Country.BY, 28, "4c,4n,16c")
        put(Country.CR, 22, "18n")
        put(Country.DJ, 27, "5n,5n,11n,2n")
        put(Country.DO, 28, "4c,20n")
        put(Country.EG, 29, "25n")
        put(Country.FK, 18, "2a,12n")
        put(Country.GE, 22, "2a,16n")
        put(Country.GT, 28, "4c,20c")
        put(Country.HN, 28, "4a,20n")
        put(Country.IL, 23, "19n")
        put(Country.IQ, 23, "4a,15n")
        put(Country.JO, 30, "4a,4n,18c")
        put(Country.KW, 30, "4a,22c")
        put(Country.KZ, 20, "3n,13c")
        put(Country.LB, 28, "4n,20c")
        put(Country.LC, 32, "4a,24c")
        put(Country.LY, 25, "21n")
        put(Country.MN, 20, "4n,12n")
        put(Country.MR, 27, "23n")
        put(Country.MU, 30, "4a,19n,3a")
        put(Country.NI, 28, "4a,20n")
        put(Country.OM, 23, "3n,16c")
        put(Country.PK, 24, "4a,16c")
        put(Country.PS, 29, "4a,21c")
        put(Country.QA, 29, "4a,21c")
        put(Country.SA, 24, "2n,18c")
        put(Country.SC, 31, "4a,20n,3a")
        put(Country.SD, 18, "14n")
        put(Country.SO, 23, "4n,3n,12n")
        put(Country.ST, 25, "21n")
        put(Country.SV, 28, "4a,20n")
        put(Country.TL, 23, "19n")
        put(Country.TN, 24, "20n")
